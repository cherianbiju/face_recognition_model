...
SVM_PATH = "models/svm_model_finetuned.pkl"  # fine-tuned SVM
...
# -----------------------------
# Load fine-tuned SVM dict
# -----------------------------
saved = joblib.load(SVM_PATH)
svm_model = saved["model"]
le = saved["label_encoder"]
print("✅ Fine-tuned SVM and LabelEncoder loaded")
...
print("\n📊 Fine-tuned SVM Evaluation Metrics (on eval_lq):")
